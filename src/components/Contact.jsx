                    ...
                    <ul className="mt-12 gap-y-6 gap-x-12 items-center md:flex lg:gap-x-0 lg:mt-0">
                        {
                            contactMethods.map((item, idx) => (
                                ...
                                ">
                                    ...
                                    <a href={item.link.href} target="_blank" rel="noreferrer" className="flex items-center gap-1 text-sm text-orange-500 duration-150 hover:text-orange-400 font-medium">
                                        {item.link.name}
